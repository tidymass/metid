...
data("snyder_database_rplc0.0.3", file = "metid")
data("orbitrap_database0.0.3", file = "metid")
data("hmdb_ms1_database0.0.3", file = "metid")
...
save(hmdb_ms1_database0.0.3, file = file.path(path, "hmdb_ms1_database0.0.3"))
```
